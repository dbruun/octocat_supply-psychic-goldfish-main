...
- **Spring Boot Controllers**: Proper request/response handling, validation, error propagation
...
2. **Code Quality Focus**
   ...
   - Type safety (avoid raw types, use concrete generics)
...
- **Types**: Concrete generics, avoid raw types, separate DTOs from entities
