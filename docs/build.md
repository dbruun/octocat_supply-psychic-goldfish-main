...
Alternatively, if you're in the `api/` or `frontend/` directories, you can use Maven and npm commands directly:
...
Alternatively, if you're in the `api/` directory, you can use the Maven wrapper directly:

```bash
cd api
./mvnw spring-boot:run -Dspring-boot.run.arguments="--init-db" -Dmaven.test.skip=true
./mvnw spring-boot:run -Dspring-boot.run.arguments="--init-db --seed-db" -Dmaven.test.skip=true
```
...
```bash
cd api && ./mvnw spring-boot:run -Dmaven.test.skip=true
...
Alternatively, if you're in the `frontend/` directory, you can use npm commands directly:
